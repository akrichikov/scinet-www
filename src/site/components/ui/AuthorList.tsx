import { formatString } from "@/site/util/utils";
import Link from "next/link";
import { getArticles } from "@/site/api/content";
import Image from "next/image";

// Define a local type for authors since ArticleType is not exported from content
...
export default async function AuthorsList() {
  const data: Array<AuthorType> = await getArticles();
